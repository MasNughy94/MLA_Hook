...
for lit_ctx in range(1, 9):
    ...
    try:
        ...
        print(f'lit_ctx={lit_ctx} (pb>>{8-lit_ctx}): match={m}/12 size={len(out):5d} first={out[:20].hex()}')
    except Exception as ex2:
        print(f'lit_ctx={lit_ctx}: ERROR {ex2}')
