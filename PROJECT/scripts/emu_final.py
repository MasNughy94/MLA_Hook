...
mt_path = r'C:\Users\ADMIN SERVICE\Videos\MLA\MLADVENTURE2\assets\0\0000488d2f64199aca0cc7d54e7d11c0.mt'
...
# Proper state init matching sub_CF2100
...
w64(STATE_ADDR + 0x30, 0)        # cf2100: output pos = 0
w32(STATE_ADDR + 0x40, 0)        # cf20e4
w32(STATE_ADDR + 0x44, 0)        # cf20e8
w32(STATE_ADDR + 0x5c, 0)        # cf20d4
w32(STATE_ADDR + 0x60, 1)        # cf20d8: FIRST-TIME flag
w32(STATE_ADDR + 0x64, 1)        # TREE INIT flag
w32(STATE_ADDR + 0x6c, 0)        # cf20dc
...
print(f'First 64 hex: {out_buf[:64].hex()}')
